	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! privates/core */ 4), __webpack_require__(/*! Base */ 26), __webpack_require__(/*! Billing */ 13), __webpack_require__(/*! privates/utils */ 9), __webpack_require__(/*! Activities */ 18), __webpack_require__(/*! Settings */ 19),
	    ...
	    var getDefaultNamespaces = function () {
	        return {
	            ...
	            hasLoginOnPage: Base.hasLoginOnPage
	        };
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MessageTypes = {
	    ...
	    HAS_LOGIN_ON_PAGE: 'hasLoginOnPage'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! privates/utils */ 9), __webpack_require__(/*! Theme */ 27), __webpack_require__(/*! WindowOrigin */ 3), __webpack_require__(/*! WindowPlacement */ 20), __webpack_require__(/*! privates/reporter */ 10), __webpack_require__(/*! privates/postMessage */ 7), __webpack_require__(/*! privates/sharedAPI */ 17), __webpack_require__(/*! privates/viewMode */ 6)], __WEBPACK_AMD_DEFINE_RESULT__ = function (utils, Theme, WindowOrigin, WindowPlacement, reporter, postMessage, sharedAPI, viewMode) {
	    ...
	    var hasLoginOnPage = function hasLoginOnPage(callback) {
	        if (!utils.isFunction(callback)) {
	            reporter.reportSdkError('Mandatory argument - callback function must be specified');
	            return;
	        }
	        postMessage.sendMessage(postMessage.MessageTypes.HAS_LOGIN_ON_PAGE, namespace, undefined, callback);
	    };
	    ...
	    return {
	        ...
	        */
	        ...
	        /**
	         * Returns true if the social login component exists on current page or master page (if page is not landing page)
	         *
	         * @function
	         * @memberOf Wix
	         * @since 1.86.0
	         * @param {function} callback called with the boolean result
	         *   callback signature: function(hasLogin) {}
	         * @example
	         *
	         * Wix.hasLoginOnPage(
	         *      function(hasLogin){console.log(hasLogin)}
	         * );
	         */
	        hasLoginOnPage: hasLoginOnPage
	    };
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
